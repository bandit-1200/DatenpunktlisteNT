...
'for-Schleife für module erstellen------------------------------------------------------------------------
'Reference a single component and grab the Code Module.
Set VBCodeMod = VBProj.VBComponents.item("Modul1").CodeModule
...
Set xml_obj = New MSXML2.XMLHTTP60
    ...
    repo_name = "DatenpunktlisteNT/"
    username = "bandit-1200/"
    file_name = "testVBA2.vba"
    access_token = "55aac133209fa6c731eb619ab7e580e36c24641b"
    ...
    'Define the Payload.
    payload = "{""message"":""ExcelVBA"",""content"":"""
...
Set VBCodeMod = VBProj.VBComponents.item("Modul2").CodeModule
